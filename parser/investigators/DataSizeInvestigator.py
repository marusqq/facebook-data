...
"""class used analyze data size and give back the results"""

from parser import util
import pandas as pd


class DataSizeInvestigator:
    def __init__(self, time_periods, big_time_period):
        self.time_periods = time_periods
        self.big_time_period = big_time_period
        self.investigated_period_data = {
            'periods': pd.DataFrame(),
            'big_period': pd.DataFrame(),
        }
